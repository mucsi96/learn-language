...
test('card editing in db', async ({ page }) => {
  ...
  await expect(page.getByText('Ideogram 4 (Quality)')).toHaveCount(1);
  ...
  await expect(page.getByText('Card updated successfully')).toBeHidden();
  ...
  await withDbConnection(async (client) => {
    ...
    expect(cardData.examples[1].images[1].model).toBe('Ideogram 4 (Quality)');
...
test('speech card editing page displays sentence and translations', async ({ page }) => {
  ...
  await page.goto('/sources/speech-a1/page/10/cards/a1b2c3d4');
...
test('speech card editing updates sentence in database', async ({ page }) => {
  ...
  await page.goto('/sources/speech-a1/page/11/cards/e5f6g7h8');
...
test('remove flag button is visible for flagged card', async ({ page }) => {
  ...
  await page.goto('/sources/goethe-a1/page/9/cards/flagged-card-visible');
...
test('remove flag unflags card in database', async ({ page }) => {
  ...
  await page.goto('/sources/goethe-a1/page/9/cards/flagged-card-unflag');
