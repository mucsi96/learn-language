...
ALTER TABLE IF EXISTS learn_language.cards
    DROP CONSTRAINT IF EXISTS cards_pkey;
ALTER TABLE learn_language.cards
    ADD CONSTRAINT cards_pkey PRIMARY KEY (id);


ALTER TABLE IF EXISTS learn_language.review_logs
    DROP CONSTRAINT IF EXISTS review_logs_pkey;
ALTER TABLE learn_language.review_logs
    ADD CONSTRAINT review_logs_pkey PRIMARY KEY (id);


ALTER TABLE IF EXISTS learn_language.sources
...
ALTER TABLE IF EXISTS learn_language.review_logs
    DROP CONSTRAINT IF EXISTS fk6qudadb9cdv57kh9g3khyench;
ALTER TABLE learn_language.review_logs
    ADD CONSTRAINT fk6qudadb9cdv57kh9g3khyench FOREIGN KEY (card_id) REFERENCES learn_language.cards(id);


ALTER TABLE IF EXISTS learn_language.cards
    DROP CONSTRAINT IF EXISTS fkjei36iycub8pvhosmh0nuqskm;
ALTER TABLE learn_language.cards
