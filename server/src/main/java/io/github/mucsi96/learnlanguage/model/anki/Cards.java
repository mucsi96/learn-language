...
public class Cards  implements java.io.Serializable {
    ...
    public Cards(int id, int nid, int did, int ord, int mod, int usn, int type, int queue, int due, int ivl, int factor, int reps, int lapses, int left, int odue, int odid, int flags, String data) {
       this.id = id;
       this.nid = nid;
       this.did = did;
       this.ord = ord;
