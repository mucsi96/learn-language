...
export class AuthService {
   ...
   * message). While set, ensureAuthenticated() will not start another
   * redirect - otherwise a rejection the authority repeats on every attempt
   * becomes an infinite redirect loop. Only an explicit user-initiated
   * login() clears it.
   */
